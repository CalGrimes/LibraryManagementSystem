...
mvn install:install-file -Dfile=jOOQ-lib/jooq-checker-$VERSION.jar                   -DgroupId=org.jooq -DartifactId=jooq-checker                   -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_CHECKER                   $SOURCES_JOOQ_CHECKER                   -DpomFile=jOOQ-pom/jooq-checker/pom.xml
mvn install:install-file -Dfile=jOOQ-lib/jooq-jackson-extensions-$VERSION.jar        -DgroupId=org.jooq -DartifactId=jooq-jackson-extensions        -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_JACKSON_EXTENSIONS        $SOURCES_JOOQ_JACKSON_EXTENSIONS        -DpomFile=jOOQ-pom/jooq-jackson-extensions/pom.xml
mvn install:install-file -Dfile=jOOQ-lib/jooq-postgres-extensions-$VERSION.jar       -DgroupId=org.jooq -DartifactId=jooq-postgres-extensions       -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_POSTGRES_EXTENSIONS       $SOURCES_JOOQ_POSTGRES_EXTENSIONS       -DpomFile=jOOQ-pom/jooq-postgres-extensions/pom.xml
...
mvn install:install-file -Dfile=jOOQ-lib/jooq-kotlin-coroutines-$VERSION.jar         -DgroupId=org.jooq -DartifactId=jooq-kotlin-coroutines         -Dversion=$VERSION -Dpackaging=jar $JAVADOC_JOOQ_KOTLIN_COROUTINES         $SOURCES_JOOQ_KOTLIN_COROUTINES         -DpomFile=jOOQ-pom/jooq-kotlin-coroutines/pom.xml
