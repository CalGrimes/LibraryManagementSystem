...
call mvn deploy:deploy-file -Dfile=jOOQ-pom\pom.xml                                      -DgroupId=org.jooq -DartifactId=jooq-parent                    -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=pom                                                                                                                                             || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-%VERSION%.jar                           -DgroupId=org.jooq -DartifactId=jooq                           -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ%                           %SOURCES_JOOQ%                           -DpomFile=jOOQ-pom\jooq\pom.xml                           || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-meta-%VERSION%.jar                      -DgroupId=org.jooq -DartifactId=jooq-meta                      -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_META%                      %SOURCES_JOOQ_META%                      -DpomFile=jOOQ-pom\jooq-meta\pom.xml                      || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-meta-extensions-%VERSION%.jar           -DgroupId=org.jooq -DartifactId=jooq-meta-extensions           -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_META_EXTENSIONS%           %SOURCES_JOOQ_META_EXTENSIONS%           -DpomFile=jOOQ-pom\jooq-meta-extensions\pom.xml           || exit /b
...
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-codegen-%VERSION%.jar                   -DgroupId=org.jooq -DartifactId=jooq-codegen                   -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_CODEGEN%                   %SOURCES_JOOQ_CODEGEN%                   -DpomFile=jOOQ-pom\jooq-codegen\pom.xml                   || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-codegen-maven-%VERSION%.jar             -DgroupId=org.jooq -DartifactId=jooq-codegen-maven             -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_CODEGEN_MAVEN%             %SOURCES_JOOQ_CODEGEN_META%              -DpomFile=jOOQ-pom\jooq-codegen-maven\pom.xml             || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-checker-%VERSION%.jar                   -DgroupId=org.jooq -DartifactId=jooq-checker                   -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_CHECKER%                   %SOURCES_JOOQ_CHECKER%                   -DpomFile=jOOQ-pom\jooq-checker\pom.xml                   || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-jackson-extensions-%VERSION%.jar        -DgroupId=org.jooq -DartifactId=jooq-jackson-extensions        -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_JACKSON_EXTENSIONS%        %SOURCES_JOOQ_JACKSON_EXTENSIONS%        -DpomFile=jOOQ-pom\jooq-jackson-extensions\pom.xml        || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-postgres-extensions-%VERSION%.jar       -DgroupId=org.jooq -DartifactId=jooq-postgres-extensions       -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_POSTGRES_EXTENSIONS%       %SOURCES_JOOQ_POSTGRES_EXTENSIONS%       -DpomFile=jOOQ-pom\jooq-postgres-extensions\pom.xml       || exit /b




call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-scala_2.13-%VERSION%.jar                -DgroupId=org.jooq -DartifactId=jooq-scala_2.13                -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_SCALA_2_13%                %SOURCES_JOOQ_SCALA_2_13%                -DpomFile=jOOQ-pom\jooq-scala_2.13\pom.xml                || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-kotlin-%VERSION%.jar                    -DgroupId=org.jooq -DartifactId=jooq-kotlin                    -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_KOTLIN%                    %SOURCES_JOOQ_KOTLIN%                    -DpomFile=jOOQ-pom\jooq-kotlin\pom.xml                    || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-kotlin-coroutines-%VERSION%.jar         -DgroupId=org.jooq -DartifactId=jooq-kotlin-coroutines         -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_KOTLIN_COROUTINES%         %SOURCES_JOOQ_KOTLIN_COROUTINES%         -DpomFile=jOOQ-pom\jooq-kotlin-coroutines\pom.xml         || exit /b
call mvn deploy:deploy-file -Dfile=jOOQ-lib\jooq-xtend-%VERSION%.jar                     -DgroupId=org.jooq -DartifactId=jooq-xtend                     -DrepositoryId=%REPOSITORY% -Durl=%URL% -Dversion=%VERSION% -Dpackaging=jar %JAVADOC_JOOQ_XTEND%                     %SOURCES_JOOQ_XTEND%                     -DpomFile=jOOQ-pom\jooq-xtend\pom.xml                     || exit /b
